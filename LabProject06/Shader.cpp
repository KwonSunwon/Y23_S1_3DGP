...
{
	WCHAR pstrShaderFileName[] = L"Shaders.hlsl";
	return(CompileShaderFromFile(pstrShaderFileName, "VSMain", "vs_5_1", ppd3dShaderBlob));
}
...
{
	WCHAR pstrShaderFileName[] = L"Shaders.hlsl";
	return(CompileShaderFromFile(pstrShaderFileName, "PSMain", "ps_5_1", ppd3dShaderBlob));
}

...
ID3D12RootSignature* CScene::CreateGraphicsRootSignature(ID3D12Device* pd3dDevice)
{
	...
	// 루트 시그니처를 생성한다.
	// 3가지 변환 모드 상수 배열로 해서 64개의 파라미터 중 48개를 사용
...
void CScene::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	m_pTerrain = new CHeightMapTerrain(pd3dDevice, pd3dCommandList,
									   m_pd3dGraphicsRootSignature, _T("./terrain2.raw"), 2049, 2049, 160,
									   160, xmf3Scale, xmf4Color);
#else
//지형을 하나의 격자 메쉬(257x257)로 생성한다. 
	m_pTerrain = new CHeightMapTerrain(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, _T("./terrain.raw"), 2049, 1025, 2049, 1025, xmf3Scale, xmf4Color);
#endif
